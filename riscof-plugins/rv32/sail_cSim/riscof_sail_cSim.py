...
class sail_cSim(pluginTemplate):
    ...
    def runTests(self, testList, cgf_file=None, header_file= None):
        ...
        for file in testList:
            ...
            # execute += self.sail_exe[self.xlen] + '  -i -v --trace=step {0} --ram-size=8796093022208 --signature-granularity=4  --test-signature={1} {2} > {3}.log 2>&1;'.format(pmp_flags, sig_file, elf, test_name)
